...
@section('content')
<div class="max-w-xl">
    <h2 class="text-xl font-bold text-gray-800 mb-6">Tambah Paket</h2>
        ...
        <form method="POST" action="{{ route('paket.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_paket" value="{{ old('nama_paket') }}"
                    ...
                    placeholder="InfiniteLite 10Mbps" required>
            </div>
            <div class="mb-4">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" name="kecepatan_download" value="{{ old('kecepatan_download') }}"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="10" required>
                </div>
                <div>
                    <label class="block text-sm text-gray-600 mb-1">Upload (Mbps)</label>
                    <input type="number" name="kecepatan_upload" value="{{ old('kecepatan_upload') }}"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
